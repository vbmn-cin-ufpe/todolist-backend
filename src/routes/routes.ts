...
router.patch('/users/:id', authMiddleware, (req, res) => userController.updateUser(req, res)); 
...
router.patch('/tasks/:taskId', authMiddleware, (req, res) => taskController.editTask(req, res));
